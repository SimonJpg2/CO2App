 ...
 * Class Form1990.
 * <p>
 *     JPanel which contains Curved Line Chart to display co2 data of 1990.
 * </p>
 * @author Simon Balcke
 * @see de.simonjpg.Frontend.UI.Form.FormDashboard
 */

public class Form1990 extends FormDashboard {
    private static final Logger LOGGER = LogManager.getLogger(Form1990.class);

    /**
     * Method setData.
     * <p>
     *     Fills Curved Line Chart with Co2 data of 1990.
     * </p>
     */
    @Override
    public void setData() {
        ...
        try {
            List<CO2Entity> entities = service.selectYear(1990);
