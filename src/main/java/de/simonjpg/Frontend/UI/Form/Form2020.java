 ...
 * Class Form2020.
 * <p>
 *     JPanel which contains Curved Line Chart to display co2 data of 2020.
 * </p>
 * @author Simon Balcke
 * @see de.simonjpg.Frontend.UI.Form.FormDashboard
 */

public class Form2020 extends FormDashboard {
    private static final Logger LOGGER = LogManager.getLogger(Form2020.class);

    /**
     * Method setData.
     * <p>
     *     Fills Curved Line Chart with Co2 data of 2020.
     * </p>
     */
    @Override
    public void setData() {
        ...
        try {
            List<CO2Entity> entities = service.selectYear(2020);
