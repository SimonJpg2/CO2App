 ...
 * Class Form2015.
 * <p>
 *     JPanel which contains Curved Line Chart to display co2 data of 2015.
 * </p>
 * @author Simon Balcke
 * @see de.simonjpg.Frontend.UI.Form.FormDashboard
 */

public class Form2015 extends FormDashboard {
    private static final Logger LOGGER = LogManager.getLogger(Form2015.class);

    /**
     * Method setData.
     * <p>
     *     Fills Curved Line Chart with Co2 data of 2015.
     * </p>
     */
    @Override
    public void setData() {
        ...
        try {
            List<CO2Entity> entities = service.selectYear(2015);
